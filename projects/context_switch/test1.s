	...
	.globl	__Z13saveRegistersP7Context     ; -- Begin function _Z13saveRegistersP7Context
	.p2align	2
__Z13saveRegistersP7Context:            ; @_Z13saveRegistersP7Context
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #16
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z13loadRegistersP7Context     ; -- Begin function _Z13loadRegistersP7Context
	.p2align	2
__Z13loadRegistersP7Context:            ; @_Z13loadRegistersP7Context
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #16
	.cfi_def_cfa_offset 16
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z12launchThreadPFviEPv        ; -- Begin function _Z12launchThreadPFviEPv
	.p2align	2
__Z12launchThreadPFviEPv:               ; @_Z12launchThreadPFviEPv
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	...
	str	x0, [sp, #8]
	str	x1, [sp]
	adrp	x8, _numThreads@PAGE
	ldr	w9, [x8, _numThreads@PAGEOFF]
	add	w9, w9, #1
	str	w9, [x8, _numThreads@PAGEOFF]
	ldr	w8, [x8, _numThreads@PAGEOFF]
	subs	w8, w8, #1
	adrp	x9, _currentThread@PAGE
	str	w8, [x9, _currentThread@PAGEOFF]
	ldr	x8, [sp, #8]
	ldr	w0, [x9, _currentThread@PAGEOFF]
	blr	x8
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z11startThreadPFviE           ; -- Begin function _Z11startThreadPFviE
	.p2align	2
__Z11startThreadPFviE:                  ; @_Z11startThreadPFviE
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
	...
	str	x8, [x9, _stack@PAGEOFF]
	adrp	x8, _currentThread@PAGE
	ldrsw	x8, [x8, _currentThread@PAGEOFF]
	mov	x9, #24
	mul	x9, x8, x9
	adrp	x8, _threadStates@PAGE
	add	x8, x8, _threadStates@PAGEOFF
	add	x0, x8, x9
	bl	__Z13saveRegistersP7Context
	ldr	x8, [sp]                        ; 8-byte Folded Reload
	ldr	x0, [sp, #8]
	ldr	x1, [x8, _stack@PAGEOFF]
	bl	__Z12launchThreadPFviEPv
	ldp	x29, x30, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #32
	ret
	.cfi_endproc
                                        ; -- End function
	.globl	__Z8shareCPUi                   ; -- Begin function _Z8shareCPUi
	.p2align	2
__Z8shareCPUi:                          ; @_Z8shareCPUi
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
	...
	bl	__Z13saveRegistersP7Context
	ldr	x8, [sp]                        ; 8-byte Folded Reload
	ldr	w8, [x8, _currentThread@PAGEOFF]
	subs	w8, w8, #1
	b.ne	LBB4_3
	b	LBB4_1
LBB4_1:
...
LBB4_5:
	adrp	x8, _currentThread@PAGE
	str	wzr, [x8, _currentThread@PAGEOFF]
	b	LBB4_6
LBB4_6:
	b	LBB4_7
LBB4_7:
	...
	add	x8, x8, _threadStates@PAGEOFF
	add	x0, x8, x9
	bl	__Z13loadRegistersP7Context
	ldp	x29, x30, [sp, #16]             ; 16-byte Folded Reload
	add	sp, sp, #32
	ret
	.cfi_endproc
                                        ; -- End function
	.globl	__Z5main1i                      ; -- Begin function _Z5main1i
	.p2align	2
__Z5main1i:                             ; @_Z5main1i
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
; %bb.0:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z5main2i                      ; -- Begin function _Z5main2i
	.p2align	2
__Z5main2i:                             ; @_Z5main2i
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
; %bb.0:
	...
	bl	__ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEPFRS3_S4_E
	adrp	x0, __Z5main1i@PAGE
	add	x0, x0, __Z5main1i@PAGEOFF
	bl	__Z11startThreadPFviE
	ldr	x0, [sp, #8]                    ; 8-byte Folded Reload
	...
	ldr	x1, [sp, #16]                   ; 8-byte Folded Reload
	bl	__ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEPFRS3_S4_E
	adrp	x0, __Z5main2i@PAGE
	add	x0, x0, __Z5main2i@PAGEOFF
	bl	__Z11startThreadPFviE
	b	LBB10_1
...
; %bb.0:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	_stack                          ; @stack
.zerofill __DATA,__common,_stack,8,3
	.globl	_currentThread                  ; @currentThread
.zerofill __DATA,__common,_currentThread,4,2
...
_numThreads:
	...
	.globl	_threadStates                   ; @threadStates
.zerofill __DATA,__common,_threadStates,72,3
	.section	__TEXT,__cstring,cstring_literals
l_.str:                                 ; @.str
	.asciz	"Main 1 says Hello"

l_.str.1:                               ; @.str.1
	.asciz	"Main 2 says Hello"

l_.str.2:                               ; @.str.2
	.asciz	"Main Start Main1"

l_.str.3:                               ; @.str.3
	.asciz	"Main Start Main2"

l_.str.4:                               ; @.str.4
	.asciz	"Share loop once in main "
